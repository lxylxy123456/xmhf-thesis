...
\pgfplotstableread[col sep=comma]{Pictures/sysbench_nested_01.csv}\mydata
...
\begin{tikzpicture}
	\begin{axis}[
		...
		\addplot table[x expr=\coordindex,y=1b]{\mydata};
		\addplot table[x expr=\coordindex,y=1k]{\mydata};
		\addplot table[x expr=\coordindex,y=1w]{\mydata};
		\addplot table[x expr=\coordindex,y=1x]{\mydata};
		\legend{1b, 1k, 1w, 1x};
	\end{axis}
\end{tikzpicture}
\end{document}
