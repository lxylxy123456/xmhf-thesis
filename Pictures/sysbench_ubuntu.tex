...
% python3 collect.py ../results/auto4/2540p_ubuntu/*
\pgfplotstableread[col sep=comma]{Pictures/sysbench_ubuntu.csv}\mydata
...
\begin{tikzpicture}
	\begin{axis}[
		...
		\addplot table[x expr=\coordindex,y=u3]{\mydata};
		\addplot table[x expr=\coordindex,y=u6]{\mydata};
		\addplot table[x expr=\coordindex,y=u9]{\mydata};
		\legend{XMHF, \XMHF64, {\XMHF64, O3}};
	\end{axis}
\end{tikzpicture}
\end{document}
